        ...
        <div class="col-md-4">
            <div class="product-item">
              <div class="pi-img-wrapper">
                <img src="noavatar.png" class="img-responsive" alt="no-avatar">
                <div>
              ...
              <form action="entreprises-accueil.php" method="POST" role="form"> <input type="hidden"  name="id" value="<?php echo $ligne["id"]; ?>"></input><input type="submit" class="btn add2cart" name="envoyer" value="Interessé?"></input></form>
...
if(isset($_POST["envoyer"]))
{
	...
	Une notification a été soumise à l'entreprise <strong>".$datas["nom"]."</strong>.";
}
 ?>
</div>
</div>