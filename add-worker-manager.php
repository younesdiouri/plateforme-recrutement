...
<?php 
include("config.php");
$req="select valeurmanager from manager";
$query=mysql_query($req);
$data=mysql_fetch_assoc($query);
$val=$data["valeurmanager"];
?>
<h1>Ajouter un worker </h1>
			<form method="post" action="add-worker-manager-exe.php">
			<div class="form-group">
			<input type="hidden" name="id" value="<?php echo $data["valeurmanager"]; ?>" />
			</div>
  <div class="form-group">
