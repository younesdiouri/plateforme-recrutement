                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                <div>
                                    <strong>Messages des managers</strong>
                                    <span class="pull-right text-muted">
                                        <em>Hier</em>
                                    </span>
                                </div>
                                <div>Bonjour laureat, ici un test de message...</div>
                            </a>
                        </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin.php"><i class="fa fa-dashboard fa-fw"></i>Acceuil</a>
                        </li>
						  <li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i>Workers<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
							<li>
                                    <a href="list-worker.php">Liste des workers</a>
                                </li>
								
                                <li>
                                    <a href="add-worker.php">Ajouter un worker</a>
                                </li>
                                <li>
