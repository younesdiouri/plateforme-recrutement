          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="entreprises-accueil.php">Les Entreprises</a></li>
                <li><a href="contract-entreprise.php">Vos contrats</a></li>
                <li><a href="cv-design.php">Votre CV</a></li>
              </ul>
            </li>
			<li><a href="modif-password.php">Changer son mot de passe</a></li>
