          ...
          <div class="panel panel-primary">
            ...
            <div class="panel-body">
              Vos Informations : <br />
				<table class="table">
					<thead>
					<tr><th>Nom</th><th>Prénom</th><th>Situation</th><th>Crédits</th></tr>
					</thead>
					<tbody>
					<tr>
					<?php 
					$req="select * from worker where login='".$_SESSION["login"]."'";
					...
					{
						$id=$data["id"];
						echo "<tr><td>".$data["nom"]."</td><td>".$data["prenom"]."</td><td>Nouveau Worker</td><td>".$data["credits"]." Crd</td></tr>";
						$data=mysql_fetch_assoc($query);
		...
		<div class="col-md-3 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					...
					echo '<strong> Parrainer un ami</strong>';
					?> 
					</h3>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php 
														$req="select count(*) from purchase where id_worker=".$id."";
														$query=mysql_query($req);
														$ligne=mysql_fetch_row($query);
														echo $ligne[0];
														?></div>
                                    <div>Nouvelles entreprises</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
														...
														<div class="modal fade" id="tinfos">
															<div class="modal-dialog">
																<div class="modal-content">
																	...
																	<?php 
																	$new="select * from purchase where id_worker=".$id."";
																	$newquery=mysql_query($new);
																	$info=mysql_fetch_assoc($newquery);
																	
																	echo '<div class="modal-body">';
																	while($info)
																	{
																	echo	'<strong>'.$info["nom_entreprise"].'</strong>: Cette entreprise est intéréssée par votre profil le ' .$info["date"].'';
																	echo '<br />';
