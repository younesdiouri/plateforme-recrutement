...
{ ?>
        <div class="col-md-4">
            <div class="product-item">
              ...
              <h3><?php echo $ligne["metier"]; ?></a></h3>
              <div class="pi-price"><?php echo $ligne["ville"]; ?></div>
              <form action="listeworker.php" method="POST" role="form"> <input type="hidden"  name="id" value="<?php echo $ligne["id"]; ?>"></input><input type="submit" class="btn add2cart" name="envoyer" value="Interessé?"></input></form>
...
{
	$id=$_POST["id"];
	$requete="select nom from worker where id=".$id."";
	...
	Une notification a été soumise au worker <strong>".$datas["nom"]."</strong>.";
}
 ?>
</div>
</div>
