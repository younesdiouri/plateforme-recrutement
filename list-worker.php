                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
									<tr><th> Nom </th><th> Prénom </th><th> Téléphone </th><th> Adresse </th><th> Ville </th><th> Cp </th> <th>Email</th><th>Metier</th><th>Justificatifs</th><th>Modifier</th><th>Supprimer</th></tr>
									</thead>
									<tbody>
									<?php
include("config.php");
...
while($ligne)
{
	...
	"</td>
	<td><img src=\"worker-file/".$ligne["login"].".jpg\"/>
